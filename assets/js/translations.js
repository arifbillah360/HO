/**
 * Translations Module
 * Contains all English (en) and Bengali (bn) translations
 */
const translations = {
    en: {
        // Navigation
        nav: {
            ...
            studentHosting: "Student Hosting",
        ...
        // Hero Section
        hero: {
            tag: "WWW.HOSTORIO.COM",
            title: "Fastest Data Center<br>Web Hosting",
            description: "We hosted more than 500+ happy customers. Small website to high traffic website customers. Get affordable web hosting package designed to help you start and run a successful website – regardless of your experience.",
        ...
        pricing: {
            ...
            plans: {
                ...
                plus: {
                    name: "Plus Cloud",
                    desc: "Best for average-sized websites"
                },
                turbo: {
                    name: "Turbo Cloud",
        ...
        domain: {
            ...
            subtitle: "Search and register your dream domain today",
            searchPlaceholder: "Search for your domain name",
            searchButton: "Search",
        ...
        // Footer
        footer: {
            description: "Hostorio provides reliable and affordable web hosting solutions for businesses of all sizes.",
            ...
            copyright: "© 2024 Hostorio. All rights reserved.",
            followUs: "Follow Us"
        }
    },
    ...
    bn: {
        ...
        nav: {
            home: "হোম",
            webHosting: "ওয়েব হোস্টিং",
            package: "প্যাকেজ",
            wordpressHosting: "ওয়ার্ডপ্রেস হোস্টিং",
            turboHosting: "টার্বো হোস্টিং",
            resellerHosting: "রিসেলার হোস্টিং",
            studentHosting: "স্টুডেন্ট হোস্টিং",
            businessEmail: "বিজনেস ইমেইল",
            vps: "ভিপিএস",
            domain: "ডোমেইন",
            domainSearch: "ডোমেইন খুঁজুন",
            domainTransfer: "ডোমেইন ট্রান্সফার",
            offer: "অফার",
        ...
        hero: {
            tag: "WWW.HOSTORIO.COM",
            title: "দ্রুততম ডেটা সেন্টার<br>ওয়েব হোস্টিং",
            description: "আমরা ৫০০+ এর বেশি সন্তুষ্ট গ্রাহকদের হোস্ট করেছি। ছোট ওয়েবসাইট থেকে উচ্চ ট্রাফিক ওয়েবসাইট গ্রাহক। আপনার অভিজ্ঞতা নির্বিশেষে একটি সফল ওয়েবসাইট শুরু এবং চালাতে সাহায্য করার জন্য ডিজাইন করা সাশ্রয়ী ওয়েব হোস্টিং প্যাকেজ পান।",
            ctaButton: "শুরু করুন"
        },
        ...
        pricing: {
            ...
            plans: {
                starter: {
                    ...
                    desc: "নতুন/ব্যক্তিগত ওয়েবসাইটের জন্য আদর্শ"
                },
                plus: {
                    name: "প্লাস ক্লাউড",
                    desc: "গড় আকারের ওয়েবসাইটের জন্য সেরা"
                },
                turbo: {
                    name: "টার্বো ক্লাউড",
                    desc: "সবচেয়ে জনপ্রিয় প্যাকেজ"
                },
                business: {
                    name: "বিজনেস ক্লাউড",
            ...
            features: {
                website: "ওয়েবসাইট",
                websites: "ওয়েবসাইট",
                unlimitedWebsites: "সীমাহীন ওয়েবসাইট",
                visitsMonthly: "মাসিক ভিজিট",
                ram: "র‍্যাম",
                storage: "স্টোরেজ",
        ...
        // Domain Section
        domain: {
            title: "আপনার নিখুঁত ডোমেইন নাম খুঁজুন",
            subtitle: "আজই আপনার স্বপ্নের ডোমেইন অনুসন্ধান এবং নিবন্ধন করুন",
            searchPlaceholder: "আপনার ডোমেইন নাম খুঁজুন",
            searchButton: "অনুসন্ধান",
            popularExtensions: "জনপ্রিয় এক্সটেনশন",
            extensions: {
                com: ".com",
                net: ".net",
                org: ".org",
        ...
        // Footer
        footer: {
            description: "Hostorio সব আকারের ব্যবসার জন্য নির্ভরযোগ্য এবং সাশ্রয়ী ওয়েব হোস্টিং সমাধান প্রদান করে।",
            ...
            hosting: {
                ...
                wordpress: "ওয়ার্ডপ্রেস হোস্টিং",
                vps: "ভিপিএস হোস্টিং",
            ...
            copyright: "© ২০২৪ Hostorio। সর্বস্বত্ব সংরক্ষিত।",
