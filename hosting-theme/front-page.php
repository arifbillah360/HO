 ...
 * Front page template.
 *
 * Renders the Hostorio homepage with dynamic pricing cards from
 * the hosting_plan CPT and Polylang-translatable strings.
 *
 * WordPress uses this template when Settings > Reading > "A static page"
 * is configured, or when no static page is set and this file exists.
 *
...
<section class="hero-section">
    <div class="container-wrapper">
        <div class="hero-content">
            <div class="hero-left">
                <div class="hero-tag"><?php hosting_pll_esc_e( 'WWW.HOSTORIO.COM' ); ?></div>
                <h1 class="hero-title">
                    <?php hosting_pll_esc_e( 'Fastest Data Center Web Hosting' ); ?>
                </h1>
                <p class="hero-description">
                    <?php hosting_pll_esc_e( 'We hosted more than 500+ happy customers. Small website to high traffic website customers. Get affordable web hosting package designed to help you start and run a successful website – regardless of your experience.' ); ?>
                </p>
                <a href="#" class="cta-button">
                    <?php hosting_pll_esc_e( 'Get Started' ); ?>
                </a>
            </div>
...
<section class="pricing-section">
    <div class="container-wrapper">
        ...
        <div class="pricing-header">
            <h2 class="pricing-main-title"><?php hosting_pll_esc_e( 'Find the Hosting Plan that\'s Right for Your Business' ); ?></h2>
            <p class="pricing-subtitle"><?php hosting_pll_esc_e( 'We Have the Features and Service You Deserve!' ); ?></p>

            <!-- Billing Toggle -->
            <div class="billing-toggle">
                <span class="toggle-label"><?php hosting_pll_esc_e( 'Billed Monthly' ); ?></span>
                <label class="toggle-switch">
                    <input type="checkbox" id="billingToggle">
                    <span class="toggle-slider"></span>
                </label>
                <span class="toggle-label active"><?php hosting_pll_esc_e( 'Billed Annually' ); ?></span>
                <span class="save-badge"><?php hosting_pll_esc_e( 'Save 15%!' ); ?></span>
            </div>
        </div>
            ...
            <div class="container-wrapper">
                ...
                <div class="cloud-pricing-cards">
                    ...
                    if ( $plans_query->have_posts() ) :
                        ...
                        // Fallback: show static cards when no hosting_plan posts exist.
                    ...
                    <div class="cloud-card pricing-card" data-price-bdt="250" data-price-usd="2.24" data-original-bdt="980" data-original-usd="8.95">
                        ...
                        <ul class="cloud-features">
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>1</strong> Website</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>~10,000</strong> Visits Monthly</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>1 GB</strong> RAM</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>FREE</strong> cPanel</span></li>
                    ...
                    <div class="cloud-card popular pricing-card" data-price-bdt="660" data-price-usd="5.99" data-original-bdt="2195" data-original-usd="19.95">
                        ...
                        <ul class="cloud-features">
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>Unlimited</strong> Websites</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>~50,000</strong> Visits Monthly</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>3 GB</strong> RAM</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>FREE</strong> Domain Name</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>FREE</strong> cPanel</span></li>
                    ...
                    <div class="cloud-card pricing-card" data-price-bdt="990" data-price-usd="8.99" data-original-bdt="3295" data-original-usd="29.95">
                        ...
                        <ul class="cloud-features">
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>Unlimited</strong> Websites</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>~100,000</strong> Visits Monthly</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>4 GB</strong> RAM</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>FREE</strong> Domain Name</span></li>
                            <li><svg class="cloud-icon-check" width="16" height="16" viewBox="0 0 16 16" fill="none"><rect width="16" height="16" rx="3" fill="#E3F2FD"/><path d="M5 8L7 10L11 6" stroke="#1976D2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span><strong>FREE</strong> cPanel</span></li>
...
<section class="domain-search-section">
    <div class="container-wrapper">
        <div class="domain-search-content">
            <h2 class="section-heading"><?php hosting_pll_esc_e( 'Your Online Journey Starts With A Perfect Domain' ); ?></h2>

            <!-- Search Box -->
            <div class="search-box-wrapper">
                <div class="search-input-container">
                    <i class="fas fa-search search-icon"></i>
                    <input type="text" class="domain-input" placeholder="<?php echo esc_attr( hosting_pll_esc( 'Find your new domain name' ) ); ?>">
                </div>
                <button class="search-button"><?php hosting_pll_esc_e( 'Search' ); ?></button>
            </div>
...
<section class="services-section">
    <div class="container-wrapper">
        ...
        <div class="section-header">
            <h2 class="section-main-title"><?php hosting_pll_esc_e( 'Your Complete Roadmap to Digital Growth' ); ?></h2>
            <p class="section-subtitle"><?php hosting_pll_esc_e( 'Hosting is just the engine—we provide the whole vehicle.' ); ?></p>
        </div>
        ...
        <div class="services-list">
            ...
            <div class="service-item reverse">
                ...
                <div class="service-content">
                    <h3 class="service-title"><?php hosting_pll_esc_e( 'Performance-First Web Hosting' ); ?></h3>
                    <p class="service-description">
                        <?php hosting_pll_esc_e( 'The Right Foundation for Every Project Whether you need the simplicity of Shared Hosting, the raw power of a VPS, or a specialized WordPress environment, we\'ve got you covered. Powered by NVMe storage and LiteSpeed Web Servers, our infrastructure is built to ensure your site stays fast, stable, and ready for high traffic.' ); ?>
                    </p>
                    <a href="#" class="service-link">
                        <span><?php hosting_pll_esc_e( 'Choose a hosting' ); ?></span>
                        <i class="arrow-icon">&rarr;</i>
                    </a>
                </div>
            </div>
            ...
            <div class="service-item">
                ...
                <div class="service-content">
                    <h3 class="service-title"><?php hosting_pll_esc_e( 'Professional Email Solutions' ); ?></h3>
                    <p class="service-description">
                        <?php hosting_pll_esc_e( 'Build Trust with Every Inbox Move beyond generic email addresses and earn instant credibility with a custom address (name@yourdomain.com). Our secure, ad-free business email plans keep your communications organized, private, and professional, complete with integrated tools to keep your team in sync.' ); ?>
                    </p>
                    <a href="#" class="service-link">
                        <span><?php hosting_pll_esc_e( 'Business Email Plans' ); ?></span>
                        <i class="arrow-icon">&rarr;</i>
                    </a>
                </div>
            </div>
            ...
            <div class="wordpress-text">
                ...
                <div class="features-list">
                    <div class="feature-item">
                        ...
                        <h3 class="feature-title"><?php hosting_pll_esc_e( '1-Click Script Deployment' ); ?></h3>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <h3 class="feature-title"><?php hosting_pll_esc_e( 'LiteSpeed-Optimized Stack' ); ?></h3>
                    </div>
                    ...
                    <div class="feature-item">
                        ...
                        <h3 class="feature-title"><?php hosting_pll_esc_e( 'Proactive Malware Defense' ); ?></h3>
                    </div>
                </div>

                <!-- CTA Button -->
                <div class="wordpress-cta">
                    <a href="#" class="cta-button"><?php hosting_pll_esc_e( 'Get Started Now' ); ?></a>
                </div>
            </div>
...
<section class="support-section">
    <div class="container-wrapper">
        <!-- Section Header -->
        <div class="section-header">
            <h2 class="section-main-title"><?php hosting_pll_esc_e( 'Customer Success Focus' ); ?></h2>
            <p class="section-subtitle"><?php hosting_pll_esc_e( 'We provide everything you need to succeed online' ); ?></p>
        </div>
        ...
        <div class="support-cards">
            ...
            <div class="support-card">
                ...
                <div class="card-content">
                    <h3 class="card-title"><?php hosting_pll_esc_e( 'Onboarding Support' ); ?></h3>
                    <p class="card-description">
                        <?php hosting_pll_esc_e( 'Don\'t know where to start? Our step-by-step tutorials and 24/7 support team walk you through domain setup, hosting configuration, and WordPress installation. From zero to live in hours, not weeks. Check our detailed knowledge base.' ); ?>
                    </p>
                    <a href="#" class="card-button"><?php hosting_pll_esc_e( 'Get started' ); ?></a>
                </div>
            </div>
            ...
            <div class="support-card">
                ...
                <div class="card-content">
                    <h3 class="card-title"><?php hosting_pll_esc_e( 'Discover our Resources' ); ?></h3>
                    <p class="card-description">
                        <?php hosting_pll_esc_e( 'Access our resource center for hosting best practices, security tips, performance optimization guides, and industry insights. Learn directly from our team\'s experience managing 500+ websites across Bangladesh.' ); ?>
                    </p>
                    <a href="#" class="card-button"><?php hosting_pll_esc_e( 'Get learning' ); ?></a>
                </div>
            </div>
            ...
            <div class="support-card">
                ...
                <div class="card-content">
                    <h3 class="card-title"><?php hosting_pll_esc_e( 'Hassle-Free Transfers' ); ?></h3>
                    <p class="card-description">
                        <?php hosting_pll_esc_e( 'We guarantee: Free domain transfer, Free email migration, Free database transfer, Zero downtime. Switching hosts shouldn\'t feel like moving houses. With us, it\'s simple.' ); ?>
                    </p>
                    <a href="#" class="card-button"><?php hosting_pll_esc_e( 'Transfer today' ); ?></a>
                </div>
            </div>
